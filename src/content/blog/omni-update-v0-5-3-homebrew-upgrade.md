...
description: "OMNI v0.5.3 adds the omni update command, automated version checks from GitHub, safety prompts before destructive operations, and full hook diagnostics."
date: 2026-03-25
tag: Release Note
