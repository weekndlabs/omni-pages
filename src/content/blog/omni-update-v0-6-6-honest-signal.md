...
description: "A self-audit found OMNI fabricating success and deleting the answer on find, ls and git log. v0.6.6 fixes seven of these and commits the benchmark."
date: 2026-07-26
tag: Release Note
...
- **No more invented verdicts.** `python`/`ruby` scripts and unparsed test output
  ...
  distiller that recognised no signal returns the raw output, and it never guesses in
