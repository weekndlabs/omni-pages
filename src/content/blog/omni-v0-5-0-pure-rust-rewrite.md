...
description: "OMNI v0.5.0 is a complete ground-up rewrite in Rust, delivering a sub-5MB binary with zero startup overhead, SQLite WAL persistence, and session-aware distillation."
date: 2026-03-23
tag: Release Note
